...
public:
    ...
    void loadGraphFromString(std::string &graph_string);
...
void Graph::loadGraphFromString(std::string &graph_string)
{
    std::istringstream iss(graph_string);

    char type;
    iss >> type >> vertices_count_ >> edges_count_;
